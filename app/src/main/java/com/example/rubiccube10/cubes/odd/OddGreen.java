...
public class OddGreen {
    ...
    public OddGreen(Paker paker) {
        ...
        blueStar = new Mercedes(dtoPm.getOddGreen(), dto24.getOddGreen(), dto20.getOddGreen(),
                dto16.getOddGreen(), dto22.getOddGreen(), dto14.getOddGreen(), dto18.getOddGreen());
        ...
        dto1 = paker.getDto1();
        dto5 = paker.getDto5();
        greenStar = new Mercedes(dtoOdd.getOddGreen(), dto11.getOddGreen(), dto7.getOddGreen(),
                dto3.getOddGreen(), dto9.getOddGreen(), dto1.getOddGreen(), dto5.getOddGreen());
        ...
        dto2 = paker.getDto2();
        dto6 = paker.getDto6();
        redStar = new Mercedes(dtoAm.getOddGreen(), dto12.getOddGreen(), dto8.getOddGreen(),
                dto4.getOddGreen(), dto10.getOddGreen(), dto2.getOddGreen(), dto6.getOddGreen());
    }
